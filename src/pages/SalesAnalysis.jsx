...
const SalesAnalysis = () => {
  ...
  const CustomizedLabel = (props) => {
    ...
    return (
      <g>
        <rect x={x + width/2 - 45} y={y + 5} width={90} height={20} rx={4} fill={fill} />
        <text x={x + width/2} y={y + 16} fill="#fff" textAnchor="middle" dominantBaseline="middle" style={{ fontSize: '11px', fontWeight: 'bold' }}>
